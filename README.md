...
```text
worker1 app relay:  CLUSTER_RELAY_UPDATE_END board=1 ok=1 status="HTTP/1.1 200 OK" elapsed_ms=109334
worker1 data relay: CLUSTER_RELAY_UPDATE_END board=1 ok=1 status="HTTP/1.1 200 OK" elapsed_ms=294371
worker1 ready:      CLUSTER_WIFI_PONG src_board=1 seq=217 from=192.168.4.3:42100 rssi=0 model_ready=1
